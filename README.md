OK, so this is an example website made with Astro and also is an opportunity to work with Tailwind and Alpine. It's extremely silly by design and just an opportunity to craft some web bits for the edge. We should still add some authentication, input sanitization on the form submits, 
